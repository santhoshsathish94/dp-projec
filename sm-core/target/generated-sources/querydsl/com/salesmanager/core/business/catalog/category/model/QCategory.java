...
public class QCategory extends EntityPathBase<Category> {
    ...
    private static final long serialVersionUID = -23277537;
    ...
    public final ListPath<Category, QCategory> categories = this.<Category, QCategory>createList("categories", Category.class, QCategory.class);
    ...
    public final ListPath<CategoryDescription, QCategoryDescription> descriptions = this.<CategoryDescription, QCategoryDescription>createList("descriptions", CategoryDescription.class, QCategoryDescription.class);
