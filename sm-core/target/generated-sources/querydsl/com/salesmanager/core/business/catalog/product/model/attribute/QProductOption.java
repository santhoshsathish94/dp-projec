...
public class QProductOption extends EntityPathBase<ProductOption> {
    ...
    public final SetPath<ProductOptionDescription, QProductOptionDescription> descriptions = this.<ProductOptionDescription, QProductOptionDescription>createSet("descriptions", ProductOptionDescription.class, QProductOptionDescription.class);
