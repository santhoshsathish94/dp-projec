...
public class SchemaConstant {
	...
	public final static String SALESMANAGER_SCHEMA = "OIMS_DEV";
	...
	public static final String[] COUNTRY_ISO_CODE = { "AF", "AX", "AL", "DZ",
			...
			"RO", "RU", "RW", "SH", "KN", "LC", "PM", "VC", "WS", "SM", "ST",
			"SA", "SN", "RS", "SC", "SL", "SG", "SK", "SI", "SB", "SO", "ZA",
			"GS", "ES", "LK", "SD", "SR", "SJ", "SZ", "SE", "CH", "SY", "TW",
			"TJ", "TZ", "TH", "TL", "TG", "TK", "TO", "TT", "TN", "TR", "TM",
			"TC", "TV", "UG", "UA", "AE", "GB", "US", "UM", "UY", "UZ", "VU",
