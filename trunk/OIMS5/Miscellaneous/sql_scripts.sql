...
CREATE TABLE `PURCHASE_RETURN_DEBIT_NOTE` (
 ...
 CREATE TABLE `JOURNAL` (
  ...
  `JOURNAL_DEBIT` varchar(100) NOT NULL,
  `JOURNAL_DEBIT_AMMOUNT` int(11) NOT NULL,
  `JOURNAL_CREDIT` varchar(100) NOT NULL,
  `JOURNAL_CREDIT_AMMOUNT` int(11) NOT NULL,
 ...
 CREATE TABLE `EXPENSE` (
  ...
  `EXPENSE_PAYMENT_MODE` int(11) NOT NULL,
  `ENTERED_BY` varchar(50) NULL,
  `MERCHANT_ID`  int(11) not null,
  `ENTRY_DATE` date NOT NULL,
