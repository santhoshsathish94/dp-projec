...
public class ProductAttributeController {
	...
	public @ResponseBody
	String pageAttributes(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			for (ProductAttribute attr : product.getAttributes()) {
				if (attr.getProductOption().getProductOptionType().equalsIgnoreCase("text")) {
	...
	private String displayAttribute(Long productId, Long id, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// get Options
		List<ProductOption> options = productOptionService.listByStoreAttrOnly(store, language);
		// get OptionsValues
	...
	public String saveAttribute(@Valid @ModelAttribute("attribute") ProductAttribute attribute, BindingResult result, Model model, HttpServletRequest request, Locale locale) throws Exception {
		...
		if (option.getProductOptionType().equals(TEXT_OPTION)) {
			...
			if (dbEntity != null && dbEntity.getProductOption().getProductOptionType().equals(TEXT_OPTION)) {// bcz
																												// it
																												// is
																												// overwrited
																												// by
	...
	public @ResponseBody
	String deleteProductPrice(HttpServletRequest request, HttpServletResponse response, Locale locale) {
	...
	public @ResponseBody
	String checkAttributeType(HttpServletRequest request, HttpServletResponse response, Locale locale) {
