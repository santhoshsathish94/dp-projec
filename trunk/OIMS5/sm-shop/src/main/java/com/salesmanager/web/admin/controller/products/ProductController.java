...
public class ProductController {
	...
	private String displayProduct(Long productId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (productId == null) {
			...
			stores.remove(user.getMerchantStore());
		}
	...
	public String saveProduct(@Valid @ModelAttribute("product") com.salesmanager.web.admin.entity.catalog.Product product, BindingResult result, Model model, HttpServletRequest request,
		 ...
		 * productOptionValueService.listByStore(store, language);
		 * List<ProductOptionValue.CustomProductOptionValues> customOptionValues
		 * = new ProductOptionValue().new
		 * CustomProductOptionValues().getCustomProductOptionValues
		 * (productOptionValues);
		 * 
		 * model.addAttribute("variantList",
		 * LogicUtils.getJSONString(customOptionValues));
		 */
	...
	public @ResponseBody
	String removeImage(HttpServletRequest request, HttpServletResponse response, Locale locale) {
	...
	public @ResponseBody
	String pageProductCategories(HttpServletRequest request, HttpServletResponse response) {
	...
	public @ResponseBody
	String deleteProductFromCategory(HttpServletRequest request, HttpServletResponse response, Locale locale) {
	...
	public String addProductToCategory(@RequestParam("productId") long productId, @RequestParam("id") long categoryId, Model model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public void saveProduct1(com.salesmanager.web.admin.entity.catalog.Product product, MerchantStore store) throws Exception {
		...
		Product newProduct = product.getProduct1();
		ProductAvailability newProductAvailability = null;
		ProductPrice newProductPrice = null;
